...
const char* C2CNS<signed char>::desc = "CNSTypeInt8";
...
asynStatus (asynPortDriver::*C2CNS<char>::asyn_callback)(signed char* value, size_t nElements, int reason, int addr) = &asynPortDriver::doCallbacksInt8Array;
asynStatus (asynPortDriver::*C2CNS<signed char>::asyn_callback)(signed char* value, size_t nElements, int reason, int addr) = &asynPortDriver::doCallbacksInt8Array;
...
asynStatus (asynPortDriver::*C2CNS<unsigned char>::asyn_callback)(signed char* value, size_t nElements, int reason, int addr) = &asynPortDriver::doCallbacksInt8Array;
asynStatus (asynPortDriver::*C2CNS<bool>::asyn_callback)(signed char* value, size_t nElements, int reason, int addr) = &asynPortDriver::doCallbacksInt8Array;
