...
/// @file NetStreamsDriver.h Header for #NetStreamsDriver class.
/// @author Freddie Akeroyd, STFC ISIS Facility, GB

#ifndef NetStreamsDRIVER_H
#define NetStreamsDRIVER_H
...
class NetStreamsDriver : public asynPortDriver 
{
public:
	NetStreamsDriver(NetStreamsInterface* netvarint, int poll_ms, const char *portName);
...
private:
	NetStreamsInterface* m_netvarint;
	int m_poll_ms;
	...
	static void NetStreamsTask(void* arg);
};

#endif /* NetStreamsDRIVER_H */
